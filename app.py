...
def streamlit_config():
    ...
    # page configuration
    st.set_page_config(page_title='DeepFinanceClassifier', layout='centered')
    ...
    # title and position
    st.markdown(f'<h1 style="text-align: center;">Financial Document Classification using Deep Learning</h1>',
...
input_file = st.file_uploader('Upload any HTML file', type='html')
